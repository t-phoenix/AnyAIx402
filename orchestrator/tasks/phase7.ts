...
export const PHASE_7_TASKS: readonly TaskDefinition[] = [
  {
    ...
    acceptanceCriteria: [
      {
        kind: 'file-exists',
        description: 'LangChain tool exists',
        path: 'packages/integrations/langchain/src/index.ts',
      },
      {
        kind: 'file-exists',
        description: 'MCP server exists',
        path: 'packages/integrations/mcp/src/index.ts',
      },
      {
        kind: 'file-contains',
        description: 'Tool name matches the documented identifier',
        path: 'packages/integrations/langchain/src/index.ts',
        pattern: 'anyx_pay_x402',
      },
      {
        kind: 'command',
        description: 'Integration tests pass',
        command: 'bun test packages/integrations',
      },
    ],
    verifyCommands: [
      { command: 'bun test packages/integrations' },
    ...
    references: [
      'docs/reference/agent-build-roadmap.md#task-71--langchain-tool',
      'docs/reference/ai-integrations.md',
    ],
  },
  {
    id: '7.2-agentkit',
    ...
    acceptanceCriteria: [
      {
        kind: 'file-exists',
        description: 'AgentKit action exists',
        path: 'packages/integrations/agentkit/src/index.ts',
      },
      {
        kind: 'file-exists',
        description: 'AgentKit README exists',
        path: 'packages/integrations/agentkit/README.md',
      },
      {
        kind: 'file-contains',
        description: 'Action identifier matches the docs',
        path: 'packages/integrations/agentkit/src/index.ts',
        pattern: 'anyx_pay_x402_api',
      },
    ],
